...
CREATE TABLE NEWS (
	...
	N_WRITEDATE DATE           NULL,     -- 작성날짜
	N_DIVISION  CHAR(2)        NULL      -- 구분
);
ALTER TABLE NEWS ADD CONSTRAINT PK_NEWS	PRIMARY KEY (N_NO);
ALTER TABLE NEWS ADD CONSTRAINT FK_MEMBER_TO_NEWS FOREIGN KEY (N_EMAIL,	N_NICK)	REFERENCES MEMBER (M_EMAIL,	M_NICK);
...
ALTER TABLE REPORT ADD CONSTRAINT FK_MEMBER_TO_REPORT FOREIGN KEY (R_EMAIL, R_NICK)	REFERENCES MEMBER (M_EMAIL, M_NICK);
...
ALTER TABLE BOARD ADD CONSTRAINT FK_MEMBER_TO_BOARD	FOREIGN KEY (M_EMAIL, M_NICK) REFERENCES MEMBER (M_EMAIL, M_NICK);
...
ALTER TABLE B_REPLY	ADD	CONSTRAINT FK_BOARD_TO_B_REPLY FOREIGN KEY (B_NO) REFERENCES BOARD (B_NO);
ALTER TABLE B_REPLY ADD CONSTRAINT FK_MEMBER_TO_B_REPLY FOREIGN KEY (M_EMAIL, M_NICK) REFERENCES MEMBER (M_EMAIL, M_NICK);
...
CREATE TABLE P_REPLY (
	...
	PR_WRITEDATE DATE           NULL      -- 작성날짜
);
ALTER TABLE P_REPLY	ADD	CONSTRAINT PK_P_REPLY PRIMARY KEY (PR_NO);
ALTER TABLE P_REPLY	ADD	CONSTRAINT FK_PRODUCT_TO_P_REPLY FOREIGN KEY (PD_NO) REFERENCES PRODUCT (PD_NO);
ALTER TABLE P_REPLY	ADD	CONSTRAINT FK_PRODUCT_TO_MEMBER FOREIGN KEY (M_EMAIL, M_NICK) REFERENCES MEMBER (M_EMAIL, M_NICK);
...
ALTER TABLE PAYMENT	ADD	CONSTRAINT FK_PRODUCT_TO_PAYMENT FOREIGN KEY (PD_NO) REFERENCES PRODUCT (PD_NO);
