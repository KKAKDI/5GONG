...
insert into PRODUCT values(1, 'ccc@daum.net', '닉네임3', '1', '닉네임4', '나이키 운동화', '0', 100000, '나이키 운동화', '나이키 운동화 10만원에 팝니다', 0, 'a1.jsp', 'a1_copy01.jsp', SYSDATE, 0);
insert into PRODUCT values(2, 'ddd@naver.com', '닉네임4', '0', null, '뉴발란스 운동화', '0', 150000, '뉴발란스 운동화', '뉴발란스 운동화 15만원에 팝니다', 0, 'a2.jsp', 'a2_copy02.jsp', SYSDATE, 0);
insert into PRODUCT values(3, 'eee@google.com', '닉네임5', '2', '닉네임3', '아디다스 운동화', '0', 120000, '아디다스 운동화', '아디다스 운동화 12만원에 팝니다', 0, 'a3.jsp', 'a3_copy03.jsp', SYSDATE, 0);
insert into PRODUCT values(4, 'ddd@naver.com', '닉네임4', '2', '닉네임5', '컨버스 단화', '0', 80000, '컨버스 단화', '컨버스 단화 8만원에 팝니다', 0, 'a4.jsp', 'a4_copy04.jsp', SYSDATE, 0);
...
insert into REPORT values(1, '닉네임3 유저 사기 신고', '닉네임3 유저가 상품 내용과 맞지않는 물품을 보내는 사기를 당했습니다', 'a.jpg', 'a_copy.jpg', 'ddd@naver.com', '닉네임4', SYSDATE, '0');
insert into REPORT values(2, '닉네임4 유저 사기 신고', '닉네임5 유저가 물품을 보내지 않습니다', 'b.jpg', 'b_copy.jpg', 'eee@google.com', '닉네임5', SYSDATE, '0');

--새소식 ( 구분 - 0:공지사항, 1:이벤트)
insert into NEWS values(1, 'aaa@naver.com', '닉네임1', '[공지]사기 대처 방법', '유저 간 거래 시 사기를 당할 경우 빠르게 신고 바랍니다', 10, SYSDATE, '0');
insert into NEWS values(2, 'bbb@google.com', '닉네임2', '[이벤트]첫 결제 시 수수료 감면 이벤트', '첫 결제 시 수수료를 감면해주는 이벤트를 진행합니다 지금 참여하세요', 10, SYSDATE, '1');

--자유게시판
insert into BOARD values(1, 'ccc@daum.net', '닉네임3', '갤S10 5G', '님들 요새 갤S10 5G 나왔던데 쓸만함?', 'aa.jpg', 'aa_copy01.jpg', 0, 0, SYSDATE);
insert into BOARD values(2, 'ddd@naver.com', '닉네임4', '다이슨 청소기', '다이슨 청소기 중고가도 너무 비싸던데...', 'bb.jpg', 'bb_copy01.jpg', 0, 0, SYSDATE);
insert into BOARD values(3, 'eee@google.com', '닉네임5', '에어팟', '에어팟1이랑 에어팟2 성능 차이 많이남?', null, null, 0, 0, SYSDATE);
