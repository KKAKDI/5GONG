...
public class ReportSQL {
	static final String sqlS = "select R_NO, R_SUBJECT, R_CONTENT, R_FILE, R_FILE_COPY, R_EMAIL, R_NICK, R_WRITEDATE, R_STATE from REPORT where R_STATE=? or R_STATE=? order by R_NO desc";
