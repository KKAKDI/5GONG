...
public class ReportSQL {
	...
	static final String sqlI = "insert into REPORT(R_NO, R_SUBJECT, R_CONTENT, R_FILE, R_FILE_COPY, R_NICK, R_WRITEDATE, R_STATE, R_REPLY, R_CLASS) values(REPORT_R_NO.nextval, ?, ?, ?, ?, ?, SYSDATE, '처리중', ?, ?)";
	...
	static final String sqlU = "update REPORT set R_STATE='처리완료', R_REPLY=? where R_NO=?";
