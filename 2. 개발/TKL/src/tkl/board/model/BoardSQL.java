...
public class BoardSQL {
	...
	static final String sqlI= "insert into BOARD(B_NO, M_EMAIL, M_NICK, B_SUBJECT, B_CONTENT, B_IMG, B_IMG_COPY, B_VIEW, B_LIKE, B_WRITEDATE,CNT) values(BOARD_B_NO.nextval, null,?,?,?,?,?,0,0,SYSDATE,0)";
