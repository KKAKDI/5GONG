...
class ProductSQL {
	...
	static final String sqlContent = "select PD_NO, PD_NICK, PD_TRUST, PD_STATUS, PD_NAME, PD_CLASS, PD_PRICE, PD_SUBJECT, PD_CONTENT, PD_VIEW, PD_IMG_COPY, PD_REGDATE from PRODUCT where PD_NO=?";
	...
	static final String sqlList2 = "select PD_NO, PD_NICK, PD_STATUS, PD_CLASS, PD_SUBJECT, PD_REGDATE, PD_VIEW, (select COUNT(*) from P_REPLY R where R.PD_NO = P.PD_NO) AS CNT from PRODUCT P where PD_CLASS=? ORDER BY PD_NO DESC";
