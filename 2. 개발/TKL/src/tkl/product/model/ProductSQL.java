...
class ProductSQL {
	...
	static final String sqlContent = "select PD_NO, PD_NICK, PD_TRUST, PD_STATUS, PD_NAME, PD_CLASS, PD_PRICE, PD_VIEW, PD_IMG_COPY, PD_REGDATE from PRODUCT where PD_NO=?";
