...
<%
			if(curBlock >0){
%>
			<a href ="board.do?m=board_list&curBlock=<%=curBlock-1%>">이전</a>
<%
			}
...
%>
           		...
           		<td><a href ="board.do?m=board_list&curBlock=<%=curBlock%>&curPage1=<%=i %>"><%=i %> | </a></td>
           		
<%
			}
			if(curBlock < pageSize/pageSizePerBlock){
%>
<a href ="board.do?m=board_list&curBlock=<%=curBlock+1%>">다음</a>
</center>
<%
			}
%>
